...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMovementException(MovementException ex, HttpServletRequest request) {
        log.warn("MovementException: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleNotReadable(HttpMessageNotReadableException ex,
        ...
        if (cause instanceof com.fasterxml.jackson.databind.exc.UnrecognizedPropertyException unrecognizedEx) {
            ...
            if (cause instanceof InvalidFormatException invalidFormatEx && isTipoMovimientoEnum(invalidFormatEx)) {
                details.put(fieldName, "El tipo de movimiento no es válido. Valores permitidos: CREDITO, DEBITO");
            } else {
    ...
    private boolean isTipoMovimientoEnum(InvalidFormatException ex) {
        return ex.getTargetType().equals(TipoMovimiento.class);
    }
}
