...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleClienteException(AcccountException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleNotReadable(HttpMessageNotReadableException ex,
        ...
        if (cause instanceof com.fasterxml.jackson.databind.exc.UnrecognizedPropertyException unrecognizedEx) {
            ...
            if (cause instanceof InvalidFormatException invalidFormatEx && isTypeEnum(invalidFormatEx)) {
                details.put(fieldName, "El tipo de cuenta no es válido. Valores permitidos: AHORROS, CORRIENTE");
            } else if (cause instanceof InvalidFormatException invalidFormatEx && isGeneroEnum(invalidFormatEx)) {
    ...
    private boolean isTypeEnum(InvalidFormatException ex) {
        return ex.getTargetType().equals(TypeEnum.class);
    }
