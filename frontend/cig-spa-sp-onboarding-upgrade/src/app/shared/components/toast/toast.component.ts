    ...
    <div class="fixed top-4 right-4 z-50 space-y-2">
      @for (toast of notificationService.toasts(); track toast.id) {
        <div
          ...
          class="min-w-80 max-w-md px-4 py-3 rounded-lg shadow-lg flex items-start justify-between animate-slide-in"
        >
          <div class="flex items-start gap-3">
            <svg class="w-5 h-5 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20" [innerHTML]="getIcon(toast.type)"></svg>
